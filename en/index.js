...
export const en = {
  header: {
    ...
    develop: 'Develop',
    workshopSeminar: 'Workshop & Seminar',
    developerSummit: 'Developer Summit',
  },
  hero: {
