export const events_homepage = {
  ...
  upcomingEvents: {
    ...
    upcomingEventsList: [
      {
        title: 'BytePlus Web3 Festival',
        link: "https://lu.ma/BytePlusWeb3Festival",
        isHot: true,
        content: '加入我们，思想领袖、创新者、投资者和爱好者齐聚一堂，探索 Web3 的深度并规划其未来发展轨迹，实现启发性的思想融合。',
        tabContent: 'Conference',
        tabColor: '#219083',
      ...
      },
      {
        ...
        link: "https://lu.ma/DubaiBuildersNight2049Afterparty",
        isHot: false,
        content: '本次活动由 ChainIDE、Mask、Beosin 和 OORT 联合主办，并得到 SocietyX 的社区支持。 欢迎加入我们，在“迪拜建筑商之夜@Token2049 余兴派对”上为区块链技术的创新、协作和无限潜力干杯。',
        tabContent: 'Afterparty',
        tabColor: '#EC6DA5',
      ...
      },
      {
        ...
        link: "https://lu.ma/UOWDubaiBACC",
        isHot: false,
        content: '与我们一起于 4 月 19 日在迪拜卧龙岗大学 (UOWD) 区块链和人工智能会议 (BAC) 上对区块链、人工智能和云计算的交叉点进行突破性探索。',
        tabContent: 'Conference',
        tabColor: '#EC6DA5',
    ...
    keyStrengthsList: [
      {
        number: '1',
        title: '学习',
        content: 'ChainIDE提供高质量且多样化的区块链课程，帮助开发者构建基于区块链的应用，从理论知识到实际开发进行学习，并从初学者到高级阶段实现突破。',
      },
      {
        number: '2',
        title: '构建',
        content: 'ChainIDE提供先进的基于云的区块链集成开发环境，使用户能够通过简单的设置和命令快速调用、查询、开发和部署底层区块链系统服务。',
      },
      {
        number: '3',
        title: '加入',
        content: 'ChainIDE为开发者提供了一个官方平台，让他们能够在蓬勃发展的区块链生态系统中进行合作和参与。加入我们，参与各种活动，共同推动区块链技术的进步。',
      },
      {
        number: '4',
        title: '实现',
